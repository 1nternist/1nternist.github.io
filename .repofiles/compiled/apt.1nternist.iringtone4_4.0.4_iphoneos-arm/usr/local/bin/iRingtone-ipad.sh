...
echo "##-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y##"
echo "##-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y-$R-$Y##"
echo "######################################################################"
...
echo "$Y######################################################################$b"
echo "$Y##$Cn           iRingtone:$b Ringtone maker for iOS                      $Y##"
...
echo "$Y##$b                                                                  $Y##"
echo "$Y##$R           NOTE: If you are on iOS 7+ then you must               $Y##"
echo "$Y##$R                 have ToneEnabler from BigBoss repo               $Y##"
echo "$Y##$R                 installed on your device.                        $Y##"
echo "$Y##$R                                                                  $Y##"
echo "$Y######################################################################$b"
}
...
if [[ -z $(echo $starttime | grep "^[0.1-9]\+$") ]] && [[ "$starttime" != "" ]]; then 
	...
	read -p "$G$b       m        Is this correct? (y/n) "$bld"" starttimeanswer
...
echo
echo "                   "$b""$bld"Done!"
echo "                   "$b"You can now find:"
echo "                   "$G""$NEW""$b".m4r"$bld""
...
if [ "$NEW" = "" ]; then
	...
	if [ "$confirm" = "y" ]; then
		echo "$G               $b Your ringtone will be saved as:"
		echo
		echo "$G                 $NEW$b.m4r"
		echo
	fi
